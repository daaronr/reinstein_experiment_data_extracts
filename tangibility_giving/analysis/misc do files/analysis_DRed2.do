...
gen time=0 //0 morning 1 afternoon
...
anova  Donation  cash performance sesnum
anova  Donation  cash performance cash*performance / cash|sesnum
anova  Donation  cash cash|sesnum performance performance|sesnum

anova  Donation  cash sesnum if performance==0
anova  Donation  performance sesnum if cash ==0

anova  Donation sesnum if performance==0
...
gen sesnumcash = cash*sesnum
gen sesnumnocash = (1-cash)*sesnum
gen sesnumperf = performance*sesnum
gen sesnumnoperf = (1-performance)*sesnum
gen sesnumnocashnoperf = (1-performance)*(1-cash)*sesnum
gen sesnumcashnoperf = (1-performance)*(cash)*sesnum
gen sesnumnocashperf = (performance)*(1-cash)*sesnum
gen sesnumcashperf = (performance)*(cash)*sesnum
...
anova  Donation shock stake75 stake10 cash cash|sesnumcashnoperf performance performance|sesnumnocashperf cashperf cashperf|sesnumcashperf sesnumnocashnoperf
reg Donation shock stake75 stake10 cash performance sesnum

gen treatments = cash*(1-performance) + 2*(1-cash)*(performance)+ 3*(cash*performance)
anova Donation treatments treatments|sesnum shock stake75 stake10 
